...
class STK_Simulation:
    ...
    def Set_Duration(self, duration_days):
        duration = datetime.timedelta(days=duration_days, seconds=0, microseconds=0, milliseconds=0, minutes=0, hours=0, weeks=0)
    ...
    def Create_Data_Comparison_df(self, Planned=True, Unplanned=False):
        data_comparison = {}
        if Unplanned:
